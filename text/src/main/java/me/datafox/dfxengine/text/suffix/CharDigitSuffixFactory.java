 ...
 */
@Component
public class CharDigitSuffixFactory implements NumberSuffixFactory {
    ...
    @Inject
    public CharDigitSuffixFactory(TextHandles handles) {
        handle = handles.getCharDigitSuffixFactory();
    }
