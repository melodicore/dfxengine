 ...
 * @author datafox
 */
public class Log10OperationSourceNodeDefinition implements SupplierNodeDefinition<SourceNode<Operation>> {
    @Override
    ...
    public static ClassTag getTag() {
        return new ClassTag("log10Op", Log10OperationSourceNodeDefinition.class);
    }
}
