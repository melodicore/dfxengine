 ...
 * injected. In the case of a field, it will be treated as a dependency and initialized right after instantiating the
 * class. Dependencies will only be injected if the class is a {@link Component} or if it is otherwise instantiated by
 * the Injector.
 *
 * @author datafox
 */
